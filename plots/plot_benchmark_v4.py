...
output_png = os.path.join(base_path, 'plots', 'benchmark_decoding_time_with_stddev_shaded_plot_reduced.png')
output_pdf = os.path.join(base_path, 'benchmark_decoding_time_with_stddev_shaded_plot_reduced.pdf')
output_svg = os.path.join(base_path, 'benchmark_decoding_time_with_stddev_shaded_plot_reduced.svg')
plt.savefig(output_png)  # Save as PNG file
